...
//-----------------------------------------------------------------------------
struct SceneOCTREENode : public BoundingVolume
{
	SceneOCTREENode *children[8]; // Array of child scene leaf pointers.
...
public:
	...
	void Render( D3DXVECTOR3 viewer );
...
private:
	...
	void RecursiveSceneFrustumCheck( SceneOCTREENode *node, D3DXVECTOR3 viewer, bool testIntersection );
	void RecursiveSceneOcclusionCheck( SceneOCTREENode *node );
	void RecursiveSceneRayCheck( SceneOCTREENode *node, RayIntersectionResult *result, D3DXVECTOR3 rayPosition, D3DXVECTOR3 rayDirection, float *hitDistance );
	void RecursiveBuildCollisionArray( SceneOCTREENode *node, SceneObject *object );
	void RecursiveOctreeSceneBuild( SceneOCTREENode *leaf, D3DXVECTOR3 translation, float halfSize );
...
private:
	...
	SceneOCTREENode *m_firstOctreeNode;

	float m_maxOctreeHalfSize; // Maximum half size of a scene leaf.
	unsigned long m_maxOctreeFaces;
};
