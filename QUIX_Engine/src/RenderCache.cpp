...
void RenderCache::End()
{
	...
	HRESULT res = m_device->DrawIndexedPrimitive( D3DPT_TRIANGLELIST, 0, 0, m_totalVertices, 0, m_faces );
	if( res != D3D_OK )
		MessageBox( 0, _T("DrawIndexedPrimitive() error"), _T("RenderCache Error"), 0 );
