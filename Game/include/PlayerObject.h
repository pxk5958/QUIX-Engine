...
public:
	...
	char GetCurrentWeaponIndex();
	Weapon* GetCurrentWeapon();
	Weapon* GetWeapon(char weapon);
...
private:
	...
	unsigned int m_id; // DirectPlay ID of the player.
	char *m_name; // Name of the player.
	char *m_model; // Model of the player
	...
	AudioPath3D *m_leftStepAudioPath;
	AudioPath3D *m_rightStepAudioPath;

	AudioPath3D *m_playerAudioPath;

	Sound *m_jumpHeaveSound;
	Sound *m_deathSound;
	Sound *m_deathBodySound;
};
